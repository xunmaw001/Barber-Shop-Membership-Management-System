          ...
          <el-form-item class="input" label="商铺名称" prop="shangpumingcheng">
              <el-input v-model="ruleForm.shangpumingcheng" 
                placeholder="商铺名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商铺地址" prop="shangpudizhi">
          <el-input v-model="ruleForm.shangpudizhi" 
              placeholder="商铺地址" clearable  :readonly="ro.shangpudizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商铺地址" prop="shangpudizhi">
              <el-input v-model="ruleForm.shangpudizhi" 
                placeholder="商铺地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商铺介绍" prop="shangpujieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangpujieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangpujieshao" label="商铺介绍" prop="shangpujieshao">
                    <span v-html="ruleForm.shangpujieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='shangpudizhi'){
            this.ruleForm.shangpudizhi = obj[o];
	    this.ro.shangpudizhi = true;
            continue;
          }
	            	            if(o=='jingyingfanwei'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='shangpujieshao'){
            this.ruleForm.shangpujieshao = obj[o];
	    this.ro.shangpujieshao = true;
            continue;
          }
	            	            if(o=='tupian'){
	...
	this.ruleForm.shangpujieshao = this.ruleForm.shangpujieshao.replace(reg,'../../../ssmun1dm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shangpuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangpuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
