    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="活动主题" prop="huodongzhuti">
          <el-input v-model="ruleForm.huodongzhuti" 
              placeholder="活动主题" clearable  :readonly="ro.huodongzhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动主题" prop="huodongzhuti">
              <el-input v-model="ruleForm.huodongzhuti" 
                placeholder="活动主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动目的" prop="huodongmude">
          <el-input v-model="ruleForm.huodongmude" 
              placeholder="活动目的" clearable  :readonly="ro.huodongmude"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动目的" prop="huodongmude">
              <el-input v-model="ruleForm.huodongmude" 
                placeholder="活动目的" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="优惠项目" prop="youhuixiangmu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="优惠项目"
                  v-model="ruleForm.youhuixiangmu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.youhuixiangmu" label="优惠项目" prop="youhuixiangmu">
                    <span>{{ruleForm.youhuixiangmu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huodongmude = true;
            continue;
	            	            ...
	            	            if(o=='youhuixiangmu'){
            this.ruleForm.youhuixiangmu = obj[o];
	    this.ro.youhuixiangmu = true;
            continue;
          }
	            	            if(o=='kaishishijian'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmun1dm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
