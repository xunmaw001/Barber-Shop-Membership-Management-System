        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="护理效果" prop="hulixiaoguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="护理效果"
                  v-model="ruleForm.hulixiaoguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.hulixiaoguo" label="护理效果" prop="hulixiaoguo">
                    <span>{{ruleForm.hulixiaoguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmuleixing = true;
            continue;
	            	            ...
	            	            if(o=='hulixiaoguo'){
            this.ruleForm.hulixiaoguo = obj[o];
	    this.ro.hulixiaoguo = true;
            continue;
          }
	            	            if(o=='jiage'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `meifaxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.meifaxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
